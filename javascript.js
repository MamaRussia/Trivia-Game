$(document).ready(function () {
    ...
    var questions = [{
        ...
        },
        {
            ...
            choice: ["Rose Petals", "Vanilla Extract", "Fresh Cut Grass", "Brut Cologne"],
            answer: 1,
        ...
        {
            question: "What do Krusty the Clown and Chandler in Friends have an extra one of?",
        ...
        {
            question: "98% of Americans feel better about themselves after they do what?",
            choice: ["Take a Shower", "Flush the Toilet", "Clean their Home", "Help the Poor"],
            answer: 1,
        ...
        {
            question: "Who was selected as Glamour magazines “10 Best Dressed College Girls?”",
            choice: ["Serena Williams", "Ann Coulter", "Martha Stewart", "Kathy Gifford"],
            answer: 2,
            photo: "assets/images/marthastewart.gif"
        },
        {
            question: "What Dr. Seuss book uses no more than 50 words?",
            choice: ["Green Eggs & Ham", "The Cat in the Hat", "If I Ran the Zoo", "Fox in Sox"],
            answer: 0,
